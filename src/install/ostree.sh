...
rsync -aAX --exclude=/dev --exclude=/proc --exclude=/sys --exclude=/run --exclude=/boot --exclude=/tmp --exclude=/var/tmp --exclude=/var/lib/containers --exclude=/output / /tmp/rootfscopy/
